...
import { AOC2021_13_1 } from "./13/part1.ts";
import { AOC2021_13_2 } from "./13/part2.ts";
...
async function main() {
  ...
  console.log(
    "13_1",
    await AOC2021_13_1(await Deno.realPath("./13/input_question.txt")),
  );
  console.log(
    "13_2",
    await AOC2021_13_2(await Deno.realPath("./13/input_question.txt")),
  );
}
